...
export const realImages: ImageData[] = [
  ...
  // Colleges
  {
    ...
    alt: "Parwati Mahila P.G. College",
    description: "Parwati Mahila P.G. College in Dohrighat",
    category: "education",
    source: "Local photography",
  },
  {
    ...
    alt: "Victory Inter College",
    description: "Victory Inter College in Dohrighat",
    category: "education",
  },
  {
    id: "college-3",
    url: "/images/college_3.png",
    alt: "Babu Ram Kailashi Devi Girls P.G. College",
    description: "Babu Ram Kailashi Devi Girls P.G. College in Dohrighat",
    category: "education",
  },
  // Other
  {
  ...
  // Healthcare
  {
    ...
    url: "/images/Government Hospital.png",
    alt: "Government Hospital, Dohrighat",
    description: "Government Hospital in Dohrighat",
    category: "healthcare",
  },
  {
    id: "maa-shakti-hospital",
    url: "/images/Maa Shakti.webp",
    alt: "Maa Shakti Multi-Speciality Hospital",
    description: "Maa Shakti Multi-Speciality Hospital in Dohrighat",
    category: "healthcare",
  },
  // Food & Sweets
  {
    id: "madhuraj-sweets",
    url: "/images/Madhuraj Sweets.png",
    alt: "Madhuraj Sweets",
    description: "Madhuraj Sweets in Dohrighat",
    category: "food",
  },
  {
    id: "gupta-sweets",
    url: "/images/gupta-sweets.png",
    alt: "Gupta Sweets",
    description: "Gupta Sweets in Dohrighat",
    category: "food",
  },
  {
    id: "vasundhara-sweets",
    url: "/images/vasundhara-sweets.png",
    alt: "Vasundhara Sweets",
    description: "Vasundhara Sweets in Dohrighat",
    category: "food",
  },
  {
    id: "mahaveer-misthan",
    url: "/images/mahaveer misthan.png",
    alt: "Mahaveer Misthan",
    description: "Mahaveer Misthan in Dohrighat",
    category: "food",
  },
  {
    id: "the-viraj-food-zone",
    url: "/images/The Viraj Food Zone.png",
    alt: "The Viraj Food Zone",
    description: "The Viraj Food Zone in Dohrighat",
    category: "food",
  },
  // Markets & Marts
  {
    id: "main-chowk-market",
    url: "/images/Main-Chowk Market.png",
    alt: "Main Chowk Market",
    description: "Main Chowk Market in Dohrighat",
    category: "markets",
  },
  {
    id: "sabji-mandi-market",
    url: "/images/Sabji-Mandi Market.png",
    alt: "Sabji Mandi Market",
    description: "Sabji Mandi Market in Dohrighat",
    category: "markets",
  },
  {
    id: "family-mart",
    url: "/images/Family-Mart.png",
    alt: "Family Mart",
    description: "Family Mart in Dohrighat",
    category: "markets",
  },
  {
    id: "ma-mart",
    url: "/images/M.A Mart.png",
    alt: "M.A Mart",
    description: "M.A Mart in Dohrighat",
    category: "markets",
  },
  {
    id: "doharighat-pool",
    ...
    alt: "Dohrighat Pool",
    description: "Dohrighat swimming pool and recreation area",
    category: "rivers",
    source: "Local photography",
  },
];
...
export const riversGhats: DohrighatPlace[] = [
  ...
  },
  {
    ...
    category: "rivers",
    subcategory: "pool",
    description: "Dohrighat swimming pool and recreation area, popular with local families.",
    latitude: 26.26,
    longitude: 83.52,
    images: ["/images/doharighat pool.png"],
    imageAlt: "Dohrighat Pool",
    nearbyAttractions: ["Ghaghara River", "Muktidhaam"],
    tips: "Best visited during summer months for a refreshing dip.",
  ...
  },
  {
    ...
    images: ["/images/doharighat pool.png", "/images/river_ghaghara.png"],
    imageAlt: "Ramghat Dohrighat",
    nearbyAttractions: ["Muktidhaam", "Ghaghara River"],
    tips: "Enjoy views of the Ghaghara river from Ramghat during sunrise.",
    verificationStatus: "VERIFIED",
    sourceUrl: "District Mau official tourism website",
    lastVerified: "2025-07-22",
  },
  {
    ...
    category: "rivers",
    subcategory: "ghat",
    description: "A ghat in Dohrighat with religious significance, associated with Maa Durga.",
    images: ["/images/durga_maa.png", "/images/river_ghaghara.png"],
    imageAlt: "Durga Ghat Dohrighat",
    nearbyAttractions: ["Durga Maa Temple", "Ramghat"],
    tips: "A peaceful ghat, ideal for quiet riverside walks.",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
  },
  {
    ...
    category: "rivers",
    subcategory: "ghat",
    description: "A ghat in Dohrighat along the banks of the Ghaghara river.",
    images: ["/images/mukti_dham2.png", "/images/river_ghaghara.png"],
    imageAlt: "Khaki Ghat Dohrighat",
    nearbyAttractions: ["Muktidhaam", "Durga Ghat"],
    tips: "Popular with locals for evening gatherings and river views.",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
  },
];
...
export const temples: DohrighatPlace[] = [
  ...
  {
    id: "shiv-temple-dohrighat",
    name: "Shiv Temple",
    category: "temples",
    subcategory: "hindu",
    description: "Shiv Temple dedicated to Lord Shiva in Dohrighat.",
  ...
  {
    id: "hanuman-ji-temple-dohrighat",
    name: "Hanuman Ji Temple",
    category: "temples",
    subcategory: "hindu",
    description: "Hanuman Ji Temple dedicated to Lord Hanuman.",
    address: "Dohrighat, Mau, Uttar Pradesh",
    images: ["/images/hanuman_ji_temple.png"],
    imageAlt: "Hanuman Ji Temple Dohrighat",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
  },
  {
    id: "sai-baba-temple-dohrighat",
    name: "Sai Baba Temple",
    category: "temples",
    subcategory: "hindu",
    description: "Sai Baba Temple dedicated to Shirdi Sai Baba.",
    address: "Dohrighat, Mau, Uttar Pradesh",
    images: ["/images/sai_baba_temple.png"],
  ...
  },
  {
    ...
    images: ["/images/durga_maa_temple.png"],
...
export const educationalInstitutes: EducationalInstitute[] = [
  ...
  {
    id: "babu-ram-kailashi-devi-girls-pg-college",
    name: "Babu Ram Kailashi Devi Girls P.G. College",
    type: "college",
    description: "A girls' PG college in Dohrighat.",
    address: "Dohrighat, Mau, Uttar Pradesh",
    images: ["/images/college_3.png"],
    verificationStatus: "VERIFIED",
    sourceUrl: "Local photography",
    lastVerified: "2025-07-22",
  },
];
...
export const foodSweets: DohrighatPlace[] = [
  {
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/Madhuraj Sweets.png"],
  },
  {
    id: "gupta-sweets",
    name: "Gupta Sweets",
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/gupta-sweets.png"],
  },
  {
    id: "vasundhara-sweets",
    name: "Vasundhara Sweets",
    category: "food",
    subcategory: "sweets",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/vasundhara-sweets.png"],
  },
  {
    id: "mahaveer-misthan",
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/mahaveer misthan.png"],
  },
  {
    id: "the-viraj-food-zone",
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/The Viraj Food Zone.png"],
  },
];
...
export const jewelleryShops: DohrighatPlace[] = [
  {
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    imageSource: "Category illustrative image",
    images: ["https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=Traditional%20Indian%20jewellery%20shop%20storefront%20in%20a%20small%20town%20in%20Uttar%20Pradesh%2C%20display%20cases%20with%20gold%20necklaces%2C%20bangles%2C%20and%20earrings%2C%20warm%20lighting%2C%20daytime%2C%20realistic%20street%20photo%20style&image_size=landscape_16_9"],
  },
  {
...
export const clothingSarees: DohrighatPlace[] = [
  {
    ...
    lastVerified: "2025-07-22",
    imageSource: "Category illustrative image",
    images: ["https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=Traditional%20Indian%20saree%20shop%20storefront%20in%20a%20small%20Uttar%20Pradesh%20town%2C%20colorful%20sarees%20hanging%20on%20display%2C%20women%27s%20clothing%2C%20vibrant%20fabrics%2C%20daytime%20street%20view&image_size=landscape_16_9"],
  },
  {
...
export const utensilsHousehold: DohrighatPlace[] = [
  {
    ...
    lastVerified: "2025-07-22",
    imageSource: "Category illustrative image",
    images: ["https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=Indian%20utensils%20bartan%20shop%20storefront%2C%20stainless%20steel%20utensils%2C%20brass%20pots%2C%20cookware%20on%20display%2C%20small%20town%20market%2C%20daytime&image_size=landscape_16_9"],
  },
];
...
export const markets: DohrighatPlace[] = [
  {
    id: "main-chowk-market",
    name: "Main Chowk Market",
    category: "markets",
    address: "Dohrighat, Uttar Pradesh 275303",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/Main-Chowk Market.png"],
  },
  {
    id: "sabji-mandi-market",
    name: "Sabji Mandi Market",
    category: "markets",
    address: "Dohrighat, Uttar Pradesh 275303",
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/Sabji-Mandi Market.png"],
  },
  {
    id: "family-mart",
    name: "Family Mart",
...
export const transport: DohrighatPlace[] = [
  {
    ...
    lastVerified: "2025-07-22",
    imageSource: "Category illustrative image",
    images: ["https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=Uttar%20Pradesh%20state%20roadways%20bus%20stand%2C%20yellow%20and%20red%20buses%20parked%2C%20passengers%20waiting%2C%20small%20town%20bus%20depot%2C%20daytime&image_size=landscape_16_9"],
  },
  {
...
export const healthcare: DohrighatPlace[] = [
  {
    ...
    verificationStatus: "PUBLICLY_LISTED",
    lastVerified: "2025-07-22",
    images: ["/images/Government Hospital.png"],
  },
  {
...
export const otherBusinesses: DohrighatPlace[] = [
  {
    ...
    lastVerified: "2025-07-22",
    imageSource: "Category illustrative image",
    images: ["https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=Indian%20plywood%20and%20hardware%20shop%20storefront%2C%20wooden%20boards%20stacked%2C%20hardware%20supplies%20on%20display%2C%20small%20town%20market%20street%2C%20daytime&image_size=landscape_16_9"],
  },
];
